<?php
    ...
    if(isset($_POST["send"])){
        ...
        if(!$error) {
            ...
            header("Location: success.php?send=1"); // ?send=1 - нужно для удостоверения отправки сообщения на странцие success.php
            exit;
        }
    }
?>
...
<body>
    ...
    <form name="feedback" action="" method="post">
        ...
        <textarea name="message" cols="30" rows="3"><?=$_SESSION["message"]?></textarea> 
